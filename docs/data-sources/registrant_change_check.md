...
- `extended_attributes` - (List) A list of extended attributes that are required for the registrant change. (see [below for nested schema](#nested-schema-for-extended_attributes))
...
- `options` (List) - A list of options for the extended attribute. (see [below for nested schema](#nested-schema-for-extended_attributesoptions))
